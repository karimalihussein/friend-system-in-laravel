...
class User extends Authenticatable
{
    ...
    {
        return $this->pendingFriendsTo()->wherePivot('friend_id', $user->id)->exists();
    ...
    // {
    //     return $this->acceptedFriendsTo->merge($this->accptedFriendsFrom);
    // }
    ...
    public function friendsstatuses()
    {
        ...
        ($this->friends(), (new User())->statuses())
        ->latest();
    }
